...
# template_folder = "D:\LearnCODE\web-basedAPP1\templates"+ "templates/"
                #  = "D:\LearnCODE\web-basedAPP1\templates"
...
def delete(idmemo):
    ...
    # sql += ' VALUES(%s,%s,%s)'
    data = (idmemo,) # tuple have to put , behide if not it will read as string
